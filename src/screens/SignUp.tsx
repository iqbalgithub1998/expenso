  ...
  return (
    <View style = {{flex:1, backgroundColor:COLORS.white}}>
        <View style = {{flex:1, marginHorizontal:22}}>
            ...
            <Text style = {styles.signUp}>Create Acount</Text>
            <Text style = {{fontSize:16, color:COLORS.grey}}>Manage your expenses starting from today !!</Text>
            </View>
        ...
        <View style = {{
            ...
            />
         <Text style={{fontSize:11}}>By Signing up you agree to the </Text>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginVertical: 20 }}>
            ...
            >
                ...
                <Pressable
                    onPress={() =>console.log("Will go to Login")}
                >
                        <Text
                            style = {{
                                fontSize: 16,
